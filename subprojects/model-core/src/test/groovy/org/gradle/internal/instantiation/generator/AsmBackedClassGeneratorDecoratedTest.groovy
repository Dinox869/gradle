...
class AsmBackedClassGeneratorDecoratedTest extends AbstractClassGeneratorSpec {
    ...
    def "assigns display name to read only nested property that is not managed"() {
        ...
        bean.finalProp.toString() == "property 'finalProp'"
        ...
        beanWithDisplayName.finalProp.toString() == "<display-name> property 'finalProp'"
